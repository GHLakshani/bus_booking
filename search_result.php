...
$query = "SELECT * FROM bus_schedule WHERE route_from = '$route_from' AND route_to = '$route_to' AND bus_type = '$bus_type' AND schedule_date = '$date'";
    ...
    <div class="container-fluid footer_row text-center">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <p class="mb-0" style="text-align: center; font-weight: 500; color: #999999;">Copyright © 2024
                    BusGoes All Rights Reserved. <br>Solution by Lakshan Basnayaka</p>
